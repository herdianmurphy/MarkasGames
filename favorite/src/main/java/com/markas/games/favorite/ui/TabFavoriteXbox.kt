...
import com.markas.games.favorite.databinding.TabFavoriteXboxBinding
import com.markas.games.ui.detail.DetailGamesActivity
import org.koin.android.viewmodel.ext.android.viewModel

class TabFavoriteXbox : Fragment() {

    private var _binding: TabFavoriteXboxBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = TabFavoriteXboxBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null) {
            ...
            favoriteViewModel.favoriteXbox.observe(viewLifecycleOwner, { dataFavorite ->
